...
const svgContent = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <defs>
    <style>
      .bg { fill: #FFFFFF; }
      .lotus-line { fill: none; stroke: #A2B3E6; stroke-width: 3.5; stroke-linecap: round; stroke-linejoin: round; }
      .navy-text { font-family: 'Times New Roman', Georgia, serif; font-weight: bold; fill: #1B2C52; }
    </style>
  </defs>
